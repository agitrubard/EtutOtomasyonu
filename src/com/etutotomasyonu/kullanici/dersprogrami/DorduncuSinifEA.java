 ...
 */
public class DorduncuSinifEA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dersProgrami.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/etutotomasyonu/kullanici/dersprogrami/images/dorduncuSinifEA.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(DorduncuSinifEA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new DorduncuSinifEA().setVisible(true);
        });
    }
