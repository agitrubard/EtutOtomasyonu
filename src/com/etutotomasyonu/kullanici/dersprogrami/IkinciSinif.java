 ...
 */
public class IkinciSinif extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dersProgrami.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/etutotomasyonu/kullanici/dersprogrami/images/ikinciSinif.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(IkinciSinif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new IkinciSinif().setVisible(true);
        });
    }
